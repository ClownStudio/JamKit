...
- (instancetype)initWithTargetTextField:(UITextField *)targetTextField{
    if (self = [super init]) {
        ...
        self.frame = CGRectMake(0, 0, WIDTH, 247);
...
- (void)initNumberKeybordUIWithDataArray:(NSArray<FYNumberPadModel*> *)dataArray{
    ...
    CGFloat const itemWidth = WIDTH/3.f;
    ...
    for (int i = 0; i < 3; i ++) {
        ...
        horizontalLineView.frame = CGRectMake(horizontalLineViewX, horizontalLineViewY, WIDTH, lineWidth);
